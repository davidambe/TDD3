...
public class Questions {
	...
	public String[] sortAlphabetically(String[] wordSequence) {
		...
		Stream<String> stringStream1 = Stream.of("bag", "bark", "car", "dog");
		Stream<String> stringStream2 = Stream.of("bag", "car", "dog");
		Stream<String> stringStream3 = Stream.of("dog", "car", "bag");
		Stream<String> stringStream4 = Stream.of("car", "bark", "bag", "dog");

		stringStream1.sorted().forEach(System.out::println);
		stringStream2.sorted().forEach(System.out::println);
		stringStream3.sorted().forEach(System.out::println);
		stringStream4.sorted().forEach(System.out::println);
	...
	public int aPlus(int num) {
		...
		/*
		 * int n1 = num * 1; int n2 = num * 2; int n3 = num * 3; int n4 = num * 4;
		 * 
		 * while (num > 0) { num = num * 1; return n1 = num; }
		 * 
		 * if (n1 > num) { n2 = num * 2; n2 = num * 3; n4 = num * 4; } int total = (n1)
		 * + (n2) + (n3) + (n4);
		 * 
	...
	public String email(String email, String parameter) {
		String emailSyntax = " ";
		String person = parameter;
		
		String Email = person + emailSyntax;
		
		if(emailSyntax == "microsoft") {
			String newEmail = person + email + "company";
		} else if(emailSyntax == "amazon") {
			String newEmail = person + email + "person";
		} else if(emailSyntax == "google") {
			String newEmail = person + email + "person";
		}
		return "";
	}
